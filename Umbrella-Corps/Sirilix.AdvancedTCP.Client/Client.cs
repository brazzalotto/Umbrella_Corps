...
using Sirilix.AdvancedTCP.Shared.Enums;
using Sirilix.AdvancedTCP.Shared.Messages;
using Sirilix.AdvancedTCP.Shared.Models;
...
namespace Sirilix.AdvancedTCP.Client
{
    public class Client
    {
        ...
        /// </summary>
        public event Action<Client, EventArguments.SessionRequestEventArguments> SessionRequest;
        /// <summary>
        ...
        /// </summary>
        public event Action<Client, EventArguments.FileUploadRequestEventArguments> FileUploadRequest;
        /// <summary>
